 ...
 *
 */
class FormacionesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'formaciones_ibfk_1' => ['type' => 'foreign', 'columns' => ['curso_id'], 'references' => ['cursos', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            'id' => 1,
            'fecha_inicio' => '2017-12-06',
            'fecha_fin' => '2017-12-06',
            'hora_inicio' => '10:59:41',
            'hora_fin' => '10:59:41',
            'curso_id' => 1,
